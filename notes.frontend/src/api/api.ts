...
/** С клиента будут приходить данные о создаваемой заметке, причем клиенту не нужно знать id пользователя соответсвенно нужно создать отдельную модель и смапить ее с командой создания заметки */
